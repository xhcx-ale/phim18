$(document).ready(() => {
  const visto = localStorage.getItem("visto"),
    ...
    audAbrir = new Audio(
      "https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/abrir.mp3"
    ),
    audSel = new Audio(
      "https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/seleccionar.mp3"
    ),
    audLike = new Audio(
      "https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/like.mp3"
    ),
    audCom = new Audio(
      "https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/comment.mp3"
    );
...
■■■■■■■■■■■■■■`;
  ...
  $("#btn-cont").on("click", () => {
    let listo = ready();
    listo ? sender(listo) : $(".argv").addClass("err");
  });
    ...
    rsImg.forEach((img) => {
      img.addEventListener("click", () => {
        ...
        const apRea = () => {
          ...
          $(".chos").css(
            "background-image",
            "url(https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/img/" +
              reaccion +
              ".png)"
          );
          $("#mgca").text("12");
        ...
        switch (reaccion) {
          ...
          case "lov":
            ...
            $(".chos").css(
              "background-image",
              "url(https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/img/lov.png)"
            );
  ...
  const likeToggle = () => {
    ...
    $("#mgd").hasClass("bi-hand-thumbs-up-fill")
      ? $(".reacNom").addClass("mgAct")
      : $(".reacNom").removeClass("mgAct");
    $("#mgd").hasClass("bi-hand-thumbs-up") ? $("#mgca").text("11") : envMg();
  };
