$(document).ready( () => {    
      const visto = localStorage.getItem('visto'),
             ...
             audAbrir = new Audio('https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/abrir.mp3'),
             audSel = new Audio('https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/seleccionar.mp3'),
             audLike = new Audio('https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/like.mp3'),
             audCom = new Audio('https://ptgez-cuentas.000webhostapp.com/foto-ale-duarte/sound/comment.mp3');
